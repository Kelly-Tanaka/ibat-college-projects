function init() {
    ...
    htmlWrite = WriteListMethod2(chemicalElements);
    writeMessagePanel(htmlToWrite,false);

    const wondersOfTheWorld = ["Great of Chin","Machu Picchu","Taj Mahal"];
    htmlToWrite = WriteListMethod3(wonderOfTheWorld);
    writeMesssagePanel(htmlToWrite);
...
function showGreeting() {
    ...
    x.innerHTML=("Week 3: working with the DOM");
    //DOm - document object model
}
